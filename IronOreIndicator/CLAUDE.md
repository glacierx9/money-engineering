...
TODO: Add detailed description of what this indicator does
...
- SampleQuote (OHLCV data) from markets: DCE
- Granularities: 900s
...
This indicator maintains the following state:
...
```bash
python ironoreindicator_viz.py
```
...
<!-- For all the changes you do I want you to maintain a journal summarizing what I made you to do from a start. It should be names journal_today's data.md and whenever you make any changes or do anything I ask you to do - Update the journal always. Nothing fancy. Very short, sweet and simple always. -->